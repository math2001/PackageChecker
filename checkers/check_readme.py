    ...
    def run(self):
        ...
        if 'color scheme' in self.labels or 'theme' in self.labels:
            if not CheckReadme.HAS_MARKDOWN_IMAGE.search(
                ...
                return self.warn('Because your package is a theme or a color '
                                 "scheme, it'd be better if you could add a "
                                 "demo in your README.md",
                                 "The valid format for an image in Markdown "
                                 "is ![alt text](your/image/path). \nSee {} "
